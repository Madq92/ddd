...
import cc.mikaka.ddd.common.sequence.impl.mysql.persistent.AddState;
...
public abstract class AbstractJdbcSynchronizer implements SeqSynchronizer {
    ...
    public void createMissingTable() {
        try (Connection connection = getConnection(); PreparedStatement statement = getCreateTableStatement(connection)) {
            statement.execute();
